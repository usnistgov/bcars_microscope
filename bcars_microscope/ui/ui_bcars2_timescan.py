...
################################################################################
## Form generated from reading UI file 'qt_bcars2_timescan.ui'
##
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.spinBox_fast_start.setValue(100.000000000000000)
        ...
        self.spinBox_fast_stop.setValue(100.000000000000000)
        ...
        self.spinBox_slow_position = QDoubleSpinBox(self.groupBox_2)
        self.spinBox_slow_position.setObjectName(u"spinBox_slow_position")
        self.spinBox_slow_position.setMinimumSize(QSize(75, 25))
        self.spinBox_slow_position.setMaximumSize(QSize(200, 40))
        self.spinBox_slow_position.setStyleSheet(u"font: 11pt \"Arial\";")
        self.spinBox_slow_position.setReadOnly(False)
        self.spinBox_slow_position.setButtonSymbols(QAbstractSpinBox.NoButtons)
        self.spinBox_slow_position.setDecimals(3)
        self.spinBox_slow_position.setMinimum(-1.000000000000000)
        self.spinBox_slow_position.setMaximum(201.000000000000000)
        self.spinBox_slow_position.setValue(1.000000000000000)

        self.verticalLayout_5.addWidget(self.spinBox_slow_position)
        ...
        self.spinBox_fixed_position = QDoubleSpinBox(self.groupBox_3)
        self.spinBox_fixed_position.setObjectName(u"spinBox_fixed_position")
        self.spinBox_fixed_position.setMinimumSize(QSize(75, 25))
        self.spinBox_fixed_position.setMaximumSize(QSize(200, 40))
        self.spinBox_fixed_position.setStyleSheet(u"font: 11pt \"Arial\";")
        self.spinBox_fixed_position.setReadOnly(False)
        self.spinBox_fixed_position.setButtonSymbols(QAbstractSpinBox.NoButtons)
        self.spinBox_fixed_position.setDecimals(3)
        self.spinBox_fixed_position.setMinimum(-1.000000000000000)
        self.spinBox_fixed_position.setMaximum(201.000000000000000)
        self.spinBox_fixed_position.setValue(100.000000000000000)

        self.verticalLayout_3.addWidget(self.spinBox_fixed_position)
        ...
        self.spinBox_time_start = QDoubleSpinBox(self.groupBox_7)
        self.spinBox_time_start.setObjectName(u"spinBox_time_start")
        self.spinBox_time_start.setMinimumSize(QSize(75, 25))
        self.spinBox_time_start.setMaximumSize(QSize(200, 40))
        self.spinBox_time_start.setStyleSheet(u"font: 11pt \"Arial\";")
        self.spinBox_time_start.setReadOnly(False)
        self.spinBox_time_start.setButtonSymbols(QAbstractSpinBox.NoButtons)
        self.spinBox_time_start.setDecimals(3)
        self.spinBox_time_start.setMinimum(-1000.000000000000000)
        self.spinBox_time_start.setMaximum(1000.000000000000000)
        self.spinBox_time_start.setSingleStep(0.100000000000000)
        self.spinBox_time_start.setValue(0.200000000000000)

        self.verticalLayout_19.addWidget(self.spinBox_time_start)
        ...
        self.spinBox_time_stop = QDoubleSpinBox(self.groupBox_7)
        self.spinBox_time_stop.setObjectName(u"spinBox_time_stop")
        self.spinBox_time_stop.setMinimumSize(QSize(75, 25))
        self.spinBox_time_stop.setMaximumSize(QSize(200, 40))
        self.spinBox_time_stop.setStyleSheet(u"font: 11pt \"Arial\";")
        self.spinBox_time_stop.setReadOnly(False)
        self.spinBox_time_stop.setButtonSymbols(QAbstractSpinBox.NoButtons)
        self.spinBox_time_stop.setDecimals(3)
        self.spinBox_time_stop.setMinimum(-1000.000000000000000)
        self.spinBox_time_stop.setMaximum(1000.000000000000000)
        self.spinBox_time_stop.setSingleStep(0.100000000000000)
        self.spinBox_time_stop.setValue(-0.600000000000000)

        self.verticalLayout_19.addWidget(self.spinBox_time_stop)
        ...
        self.spinBox_time_steps = QSpinBox(self.groupBox_7)
        self.spinBox_time_steps.setObjectName(u"spinBox_time_steps")
        self.spinBox_time_steps.setButtonSymbols(QAbstractSpinBox.NoButtons)
        self.spinBox_time_steps.setMinimum(1)
        self.spinBox_time_steps.setMaximum(50000)
        self.spinBox_time_steps.setValue(100)

        self.verticalLayout_19.addWidget(self.spinBox_time_steps)
        ...
        self.spinBox_fast_stepsize_2 = QDoubleSpinBox(self.groupBox_7)
        self.spinBox_fast_stepsize_2.setObjectName(u"spinBox_fast_stepsize_2")
        self.spinBox_fast_stepsize_2.setEnabled(False)
        self.spinBox_fast_stepsize_2.setMinimumSize(QSize(75, 25))
        self.spinBox_fast_stepsize_2.setMaximumSize(QSize(200, 40))
        self.spinBox_fast_stepsize_2.setStyleSheet(u"font: 11pt \"Arial\";")
        self.spinBox_fast_stepsize_2.setReadOnly(True)
        self.spinBox_fast_stepsize_2.setButtonSymbols(QAbstractSpinBox.NoButtons)
        self.spinBox_fast_stepsize_2.setDecimals(3)
        self.spinBox_fast_stepsize_2.setMinimum(-200.000000000000000)
        self.spinBox_fast_stepsize_2.setMaximum(200.000000000000000)
        self.spinBox_fast_stepsize_2.setValue(1.000000000000000)

        self.verticalLayout_19.addWidget(self.spinBox_fast_stepsize_2)
...
"QCheckBox::indicator:disabled { background-color:rgb(100,100,100);}")
        ...
        self.formLayout_3.setWidget(0, QFormLayout.LabelRole, self.label_25)
        ...
        self.menubar.setGeometry(QRect(0, 0, 1661, 22))
        ...
        QWidget.setTabOrder(self.comboBoxSlow, self.spinBox_slow_position)
        QWidget.setTabOrder(self.spinBox_slow_position, self.comboBoxFixed)
        QWidget.setTabOrder(self.comboBoxFixed, self.spinBox_fixed_position)
        QWidget.setTabOrder(self.spinBox_fixed_position, self.spinBox_post_image_z_pos)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_6.setText(QCoreApplication.translate("MainWindow", u"Position (um)", None))
        ...
        self.label_10.setText(QCoreApplication.translate("MainWindow", u"Position (um)", None))
        self.groupBox_7.setTitle(QCoreApplication.translate("MainWindow", u"Time Axis", None))
        self.label_7.setText(QCoreApplication.translate("MainWindow", u"Start (mm)", None))
        self.label_11.setText(QCoreApplication.translate("MainWindow", u"Stop (mm)", None))
        self.label_8.setText(QCoreApplication.translate("MainWindow", u"Steps", None))
        self.label_24.setText(QCoreApplication.translate("MainWindow", u"Step Size (mm)", None))
        ...
        self.lineEditGroupName.setText(QCoreApplication.translate("MainWindow", u"/TimeScan", None))
...
"SC Power = 11 mW", None))
        ...
        self.label_25.setText(QCoreApplication.translate("MainWindow", u"Frequency Index", None))
