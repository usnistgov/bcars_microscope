...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.spinBox_x_pos.setMinimumSize(QSize(50, 25))
        self.spinBox_x_pos.setMaximumSize(QSize(50, 25))
        ...
        self.spinBox_x_setpos.setMinimumSize(QSize(50, 25))
        self.spinBox_x_setpos.setMaximumSize(QSize(50, 25))
        ...
        self.pushButton_moveX.setMaximumSize(QSize(16777215, 25))
        ...
        self.spinBox_y_pos.setMinimumSize(QSize(50, 25))
        self.spinBox_y_pos.setMaximumSize(QSize(50, 25))
        ...
        self.spinBox_y_setpos.setMinimumSize(QSize(50, 25))
        self.spinBox_y_setpos.setMaximumSize(QSize(50, 25))
        ...
        self.pushButton_moveY.setMaximumSize(QSize(16777215, 25))
        ...
        self.spinBox_z_pos.setMinimumSize(QSize(50, 25))
        self.spinBox_z_pos.setMaximumSize(QSize(50, 25))
        ...
        self.spinBox_z_setpos.setMinimumSize(QSize(50, 25))
        self.spinBox_z_setpos.setMaximumSize(QSize(50, 25))
        ...
        self.pushButton_moveZ.setMaximumSize(QSize(16777215, 25))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_4.setText(QCoreApplication.translate("MainWindow", u"<html><head/><body><p><span style=\" font-size:12pt; font-weight:600;\">Current</span><br/><span style=\" font-size:12pt; font-weight:600;\">Position</span></p></body></html>", None))
        self.label_5.setText(QCoreApplication.translate("MainWindow", u"<html><head/><body><p><br/><span style=\" font-size:12pt; font-weight:600;\">Set Position</span></p></body></html>", None))
