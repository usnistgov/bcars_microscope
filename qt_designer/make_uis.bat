call pyuic5.bat .\qt_bcars2_raster.ui -o ..\bcars_microscope\ui\ui_bcars2_raster.py

call pyuic5.bat .\qt_bcars2_macro.ui -o ..\bcars_microscope\ui\ui_bcars2_macro.py
call pyuic5.bat .\qt_bcars2_timescan.ui -o ..\bcars_microscope\ui\ui_bcars2_timescan.py
call pyuic5.bat .\qt_bcars2_spectroscopy.ui -o ..\bcars_microscope\ui\ui_bcars2_spectroscopy.py
