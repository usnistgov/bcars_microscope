...
# Form implementation generated from reading ui file '.\qt_designer\qt_bcars2_pi_nano.ui'
#
...
class Ui_Dialog(object):
    ...
    def retranslateUi(self, Dialog):
        ...
        self.label_2.setText(_translate("Dialog", "Velocity (um/s)"))
        self.label.setText(_translate("Dialog", "N.B.: Settings applied to all axes"))
